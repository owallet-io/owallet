  ...
  return (
    <PageScrollPositionProvider>
      <FocusedScreenProvider>
        ...
        >
          <Stack.Navigator
            initialRouteName={keyRingStore.status !== 'unlocked' ? SCREENS.STACK.PincodeUnlock : SCREENS.STACK.MainTab}
          ...
          >
            ...
            />
            <Stack.Screen name={SCREENS.RegisterRecoverPhrase} component={RecoverMnemonicScreen} />
