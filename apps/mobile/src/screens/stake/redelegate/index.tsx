...
import { useGasSimulator, useRedelegateTxConfig, useTxConfigsValidate } from '@owallet/hooks';
...
export const RedelegateScreen: FunctionComponent = observer(() => {
  ...
  const { chainStore, accountStore, queriesStore, modalStore, priceStore, appInitStore } = useStore();
  ...
  const sendConfigs = useRedelegateTxConfig(chainStore, queriesStore, chainId, sender, validatorAddress, 300000);
                ...
                >
                  ...
                  >
                    ...
                    <OWText style={{ paddingLeft: 4 }} color={colors['neutral-text-body']} size={14}>
                      {priceStore.calculatePrice(sendConfigs.amountConfig.amount[0]).toString()}
                    </OWText>
                  </View>
                  <View
                    style={{
