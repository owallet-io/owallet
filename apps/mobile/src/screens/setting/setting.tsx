...
export const NewSettingScreen: FunctionComponent = observer(props => {
  const { keychainStore, keyRingStore, priceStore, modalStore, accountStore, appInitStore } = useStore();
      ...
      <View>
        ...
        >
          <BasicSettingItem
            ...
            icon="owallet"
            paragraph={selected ? selected.meta?.name || 'OWallet Account' : 'No Account'}
          ...
          {canShowPrivateData(keyRingStore.keyRingType) && <SettingViewPrivateDataItem />}
