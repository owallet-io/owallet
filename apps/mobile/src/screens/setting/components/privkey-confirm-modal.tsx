    ...
    <ScrollView keyboardDismissMode="interactive" keyboardShouldPersistTaps="handled">
      ...
      >
        <View style={{ flexDirection: 'row', paddingBottom: 6, alignItems: 'center' }}>
          ...
          <OWText style={{ paddingLeft: 4 }} color={colors['warning-border-default']} weight="500" size={14}>
            The private key you are about to generate will only function within {chainInfo.chainName} network. Do you
            wish to proceed?
          </OWText>
        </View>
      </View>
