        ...
        <Box style={style.flatten(['padding-12', 'padding-top-0'])}>
          ...
          <XAxis>
            <OWButton
              ...
              onPress={async () => {
                await signEthereumInteractionStore.rejectWithProceedNext(interactionData.id, () => {});
              }}
            />
            ...
            <OWButton
              ...
              style={{ flex: 1, width: '100%' }}
              loading={signEthereumInteractionStore.isObsoleteInteraction(interactionData.id) || isLedgerInteracting}
              onPress={approve}
            />
          </XAxis>
        </Box>
