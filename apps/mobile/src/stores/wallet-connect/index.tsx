...
// const getRandomBytesAsync = async (size) => {
...
export class WalletConnectStore {
  ...
  protected async init(): Promise<void> {
    const projectId = "2bd21bae70d0708420acba90a33cd752";
    if (!projectId) {
      return;
    }
  ...
  protected async onSessionRequest(event: any): Promise<void> {
    ...
    try {
      ...
      // OWallet asks permission to user according to requests.
  ...
  protected createOWalletAPI(id: string) {
    return new OWallet(
      // TODO: Set version
      "",
      "core",
