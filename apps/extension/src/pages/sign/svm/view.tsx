...
import {
    useAmountConfig,
    useFeeConfig, useGasConfig,
    useSenderConfig,
} from "@owallet/hooks";
import {handleExternalInteractionWithNoProceedNext} from "../../../utils";
import {_getPriorityFeeSolana, deserializeTransaction, getSimulationTxSolana, MemoryKVStore} from "@owallet/common";
...
export const SvmSigningView: FunctionComponent<{
    ...
    console.log(simulationData?.status === "SUCCESS", "simulationData?.status === \"SUCCESS\"");
    return (
        <HeaderLayout
            title={"Sign Solana"}
            fixedHeight={true}
                            ...
                            {isViewData ? (
                                ...
                                <Box padding="1rem">
                                    ...
                                    interactionData.data.signType === "sign-transaction" ? (
                                        <Body2 color={theme.mode === "light"
                                            ? ColorPalette["gray-300"]
                                            : ColorPalette["gray-100"]}>Simulating...</Body2>
                                    ) : null}
                                    {hasError ? (
                                        <Box width="100%">
                                            {/*<Gutter size={16} />*/}
