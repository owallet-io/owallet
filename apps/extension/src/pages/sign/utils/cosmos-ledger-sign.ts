...
import { CosmosApp } from "@owallet/ledger-cosmos";
import { OWalletError } from "@owallet/router";
import { PubKeySecp256k1 } from "@owallet/crypto";
import { Buffer } from "buffer/";
import { StdSignDoc } from "@owallet/types";
import { serializeSignDoc } from "@owallet/cosmos";
import { signatureImport } from "secp256k1";
import { LedgerUtils } from "../../../utils";
import Eth from "@ledgerhq/hw-app-eth";
import { EIP712MessageValidator } from "@owallet/background";
import { domainHash, messageHash } from "@owallet/background";
