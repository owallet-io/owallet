...
export class SwapCosmosWallet extends CosmosWallet {
  ...
  constructor(params: { client: SigningCosmWasmClient; owallet: OWallet }) {
    super();
    this.client = params.client;
    this.owallet = params.owallet;
  }
...
export class SwapEvmWallet extends EvmWallet {
  ...
  constructor(params: { isTronToken: boolean; tronWeb: TronWeb; ethereum: Ethereum }) {
    super();
    this.ethereum = params.ethereum;
    this.isTronToken = params.isTronToken;
