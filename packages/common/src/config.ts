...
export const CoinGeckoAPIEndPoint = process.env['KEPLR_EXT_COINGECKO_ENDPOINT'] || 'https://api.coingecko.com/api/v3';
...
export const CoinGeckoGetPrice = process.env['KEPLR_EXT_COINGECKO_GETPRICE'] || '/simple/price';
...
export const EthereumEndpoint = process.env['KEPLR_EXT_ETHEREUM_ENDPOINT'] || 'https://evm-1.keplr.app';

export const TokenContractListURL = 'https://opbaqquqruxn7fdsgcncrtfrwa0qxnoj.lambda-url.us-west-2.on.aws/';
export const TokenContractListRepoURL = 'https://github.com/chainapsis/keplr-contract-registry';
...
export const ICNSInfo = {
  chainId: 'osmosis-1',
  resolverContractAddress: 'osmo1xk0s8xgktn9x5vwcgtjdxqzadg88fgn33p8u9cnpdxwemvxscvast52cdd'
};
...
export const EmbedChainInfos: ChainInfo[] = [
  {
    ...
    stakeCurrency: {
      ...
      coinImageUrl: 'https://raw.githubusercontent.com/chainapsis/keplr-chain-registry/main/images/Oraichain/chain.png'
    },
    chainSymbolImageUrl:
  ...
  },
  {
    ...
    currencies: [
      ...
      },
      {
        ...
        coinImageUrl: 'https://raw.githubusercontent.com/chainapsis/keplr-chain-registry/main/images/eip155:1/chain.png'
      }
    ],
    feeCurrencies: [
      {
...

  {
    ...
    features: ['ibc-transfer', 'ibc-go', 'cosmwasm', 'wasmd_0.24+', 'osmosis-txfees']
  },
  {
...
export const ChainIdentifierToTxExplorerMap: Record<string, { name: string; txUrl: string } | undefined> = {
  cosmoshub: {
    name: 'Mintscan',
...
export const CommunityChainInfoRepo = {
  ...
  branchName: 'main',
  alternativeURL: process.env['KEPLR_EXT_CHAIN_REGISTRY_URL'] ? process.env['KEPLR_EXT_CHAIN_REGISTRY_URL'] : undefined
};

export const APR_API_URL = 'https://pjld2aanw3elvteui4gwyxgx4m0ceweg.lambda-url.us-west-2.on.aws';

export const SCAMPORPOSAL_API_URL = 'https://phishing-block-list-chainapsis.vercel.app';
