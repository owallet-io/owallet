...
export const AprByChain = 'https://pjld2aanw3elvteui4gwyxgx4m0ceweg.lambda-url.us-west-2.on.aws';
...
export const EmbedChainInfos: AppChainInfo[] = [
    ...
    get currencies() {
      return [
        ...
        },
        {
          type: 'cw20',
          coinDenom: 'SCORAI',
          coinMinimalDenom: 'cw20:orai1065qe48g7aemju045aeyprflytemx7kecxkf5m7u5h5mphd0qlcs47pclp:stake-comp-orai',
          contractAddress: 'orai1065qe48g7aemju045aeyprflytemx7kecxkf5m7u5h5mphd0qlcs47pclp',
          coinDecimals: 6,
          coinGeckoId: 'scorai',
          coinImageUrl: 'https://assets.coingecko.com/coins/images/28897/standard/Orchai_LOGO.png'
        },
        {
          type: 'cw20',
          coinDenom: 'OCH',
        ...
        },
        {
          ...
          coinImageUrl: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/oraichain/images/oraix.png'
        },
        {
          type: 'cw20',
          coinDenom: 'USDT',
        ...
        },
        {
          coinDenom: 'WETH',
          coinGeckoId: 'weth',
          coinMinimalDenom: 'cw20:orai1dqa52a7hxxuv8ghe7q5v0s36ra0cthea960q2cukznleqhk0wpnshfegez:WETH',
          type: 'cw20',
...

  {
    ...
    stakeCurrency: {
      ...
      coinDecimals: 18,
      coinGeckoId: 'injective-protocol',
      coinImageUrl: 'https://assets.coingecko.com/coins/images/12882/standard/Secondary_Symbol.png?1696512670',
      gasPriceStep: {
        low: 5000000000,
        average: 25000000000,
        high: 50000000000
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinDecimals: 6,
      coinGeckoId: 'cosmos',
      coinImageUrl: 'https://assets.coingecko.com/coins/images/1481/standard/cosmos_hub.png',
      gasPriceStep: {
        low: 0.02,
        average: 0.025,
        high: 0.04
    ...
    chainSymbolImageUrl: 'https://assets.coingecko.com/coins/images/1481/standard/cosmos_hub.png',
    txExplorer: {
      name: 'Scanium',
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinDecimals: 6,
      coinGeckoId: 'osmosis',
      coinImageUrl: 'https://assets.coingecko.com/coins/images/16724/standard/osmo.png',
      gasPriceStep: {
        low: 0.0025,
        average: 0.025,
        high: 0.04
    ...
    currencies: [
      ...
      },
      {
        ...
        coinDecimals: 6,
        coinGeckoId: 'ion',
        coinImageUrl: 'https://assets.coingecko.com/coins/images/16731/standard/ion-osmosis.png'
      }
    ],
    get feeCurrencies() {
      return [this.stakeCurrency];
    ...
    coinType: 118,
    features: ['stargate', 'ibc-transfer', 'no-legacy-stdTx', 'ibc-go'],
    chainSymbolImageUrl: 'https://assets.coingecko.com/coins/images/16724/standard/osmo.png',
    txExplorer: {
      name: 'Scanium',
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinImageUrl: 'https://assets.coingecko.com/coins/images/31967/standard/tia.jpg?1696530772',
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinImageUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/7431.png'
    },
    bip44: {
      coinType: 118
    },
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinImageUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/28324.png'
    },
    bip44: {
      coinType: 118
    },
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinImageUrl: 'https://assets.coingecko.com/coins/images/22363/standard/pink_star_200.png'
    },
    bip44: {
      coinType: 118
    },
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinDecimals: 6,
      coinImageUrl: 'https://www.mintscan.io/assets/chains/_rendered/noble@3x.png',
      gasPriceStep: {
        low: 1,
        average: 1.5,
        high: 2
  ...
  },
  {
    ...
    currencies: [
      ...
      {
        coinDenom: 'ORAIX',
        coinMinimalDenom: 'erc20:0x2d869aE129e308F94Cc47E66eaefb448CEe0d03e:ORAIX Token',
  ...
  },
  {
    ...
    get currencies() {
      return [
        ...
        {
          coinDenom: 'BSC-USD',
          coinMinimalDenom: 'erc20:0x55d398326f99059fF775485246999027B3197955:Binance Bridged USDT (BNB Smart Chain)',
          coinDecimals: 18,
...

  {
    ...
    currencies: [
      ...
      },
      {
        ...
        coinDenom: 'USDC',
        coinMinimalDenom: 'erc20:0x3487b63D30B5B2C87fb7fFa8bcfADE38EAaC1abe:USDC Token',
        coinGeckoId: 'usd-coin',
        coinImageUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/3408.png',
        coinDecimals: 6
      },
      ...
      // },
      {
        ...
        coinMinimalDenom: 'erc20:0xa614f803B6FD780986A42c78Ec9c7f77e6DeD13C:USDT Token',
        coinDenom: 'USDT',
        coinDecimals: 6,
        coinGeckoId: 'tether',
        coinImageUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/825.png'
      },
      {
        ...
        coinMinimalDenom: 'erc20:0x891cdb91d149f23B1a45D9c5Ca78a88d0cB44C18:Wrapped Tron',
        coinDenom: 'WTRX',
        coinDecimals: 6,
  ...
  },
  {
    ...
    networkType: 'evm',
    chainName: 'Oasis',
    chainSymbolImageUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/7653.png',
    stakeCurrency: {
      coinDenom: 'ROSE',
  ...
  },
  {
    ...
    txExplorer: {
      ...
      accountUrl: 'https://explorer.oasis.io/mainnet/sapphire/address/{address}'
    }
  },
  {
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinMinimalDenom: 'ustake',
      coinDecimals: 6,
      coinImageUrl: 'https://s2.coinmarketcap.com/static/img/coins/64x64/26680.png'
    },
    bip44: {
      coinType: 118
    },
  ...
  },
  {
    ...
    // rpc: 'http://134.209.164.196:20057',
    // rest: 'http://134.209.164.196:20017',
    ...
    get currencies() {
      return [
        this.stakeCurrency,
        {
          type: 'cw20',
          coinDenom: 'AIRI',
          coinMinimalDenom: 'cw20:orai1gwe4q8gme54wdk0gcrtsh4ykwvd7l9n3dxxas2:aiRight Token',
  ...
  },
  {
    ...
    stakeCurrency: {
      ...
      coinImageUrl: 'https://assets.coingecko.com/coins/images/19249/standard/Juno_Logo_%28Salmon%29_%282%29.png',
      gasPriceStep: {
        low: 0.1,
        average: 0.25,
        high: 0.4
    ...
    features: ['cosmwasm', 'no-legacy-stdTx', 'ibc-transfer', 'ibc-go', 'wasmd_0.24+'],
    chainSymbolImageUrl: 'https://assets.coingecko.com/coins/images/19249/standard/Juno_Logo_%28Salmon%29_%282%29.png',
    txExplorer: {
      name: 'Scanium',
