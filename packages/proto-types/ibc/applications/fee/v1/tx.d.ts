...
export declare const MsgRegisterPayee: {
  ...
  create<
    I extends {
      ...
      relayer?: string;
      payee?: string;
    } & { [K in Exclude<keyof I, keyof MsgRegisterPayee>]: never }
  >(
    base?: I
  ): MsgRegisterPayee;
  fromPartial<
    I_1 extends {
      ...
      relayer?: string;
      payee?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgRegisterPayee>]: never }
  >(
    object: I_1
  ): MsgRegisterPayee;
};
...
export declare const MsgRegisterCounterpartyPayee: {
  ...
  create<
    I extends {
      ...
      relayer?: string;
      counterpartyPayee?: string;
    } & { [K in Exclude<keyof I, keyof MsgRegisterCounterpartyPayee>]: never }
  >(
    base?: I
  ): MsgRegisterCounterpartyPayee;
  fromPartial<
    I_1 extends {
      ...
      [K_1 in Exclude<keyof I_1, keyof MsgRegisterCounterpartyPayee>]: never;
    }
  >(
    object: I_1
  ): MsgRegisterCounterpartyPayee;
...
export declare const MsgPayPacketFee: {
  ...
  create<
    ...
    } & { [K_8 in Exclude<keyof I, keyof MsgPayPacketFee>]: never }
  >(
    base?: I
  ): MsgPayPacketFee;
  fromPartial<
    ...
    } & { [K_17 in Exclude<keyof I_1, keyof MsgPayPacketFee>]: never }
  >(
    object: I_1
  ): MsgPayPacketFee;
};
    ...
    I extends {
      ...
      packetFee?: {
        ...
        fee?: {
          ...
          recvFee?: {
            ...
            ({
              ...
              [K_1 in Exclude<
                keyof I["packetFee"]["fee"]["recvFee"][number],
                keyof import("../../../../cosmos/base/v1beta1/coin").Coin
              >]: never;
            })[] & {
              [K_2 in Exclude<
                keyof I["packetFee"]["fee"]["recvFee"],
                keyof {
                  denom?: string;
                  amount?: string;
                }[]
          ...
          ackFee?: {
            ...
            ({
              ...
              [K_3 in Exclude<
                keyof I["packetFee"]["fee"]["ackFee"][number],
                keyof import("../../../../cosmos/base/v1beta1/coin").Coin
              >]: never;
            })[] & {
              [K_4 in Exclude<
                keyof I["packetFee"]["fee"]["ackFee"],
                keyof {
                  denom?: string;
                  amount?: string;
                }[]
          ...
          timeoutFee?: {
            ...
            ({
              ...
              [K_5 in Exclude<
                keyof I["packetFee"]["fee"]["timeoutFee"][number],
                keyof import("../../../../cosmos/base/v1beta1/coin").Coin
              >]: never;
            })[] & {
              [K_6 in Exclude<
                keyof I["packetFee"]["fee"]["timeoutFee"],
                keyof {
                  denom?: string;
                  amount?: string;
                }[]
        ...
        relayers?: string[] &
          string[] & {
            [K_8 in Exclude<
              keyof I["packetFee"]["relayers"],
              keyof string[]
            >]: never;
          };
      } & { [K_9 in Exclude<keyof I["packetFee"], keyof PacketFee>]: never };
    } & { [K_10 in Exclude<keyof I, keyof MsgPayPacketFeeAsync>]: never }
  >(
    base?: I
    ...
    I_1 extends {
      ...
      packetFee?: {
        ...
        fee?: {
          ...
          recvFee?: {
            ...
            ({
              ...
              [K_12 in Exclude<
                keyof I_1["packetFee"]["fee"]["recvFee"][number],
                keyof import("../../../../cosmos/base/v1beta1/coin").Coin
              >]: never;
            })[] & {
              [K_13 in Exclude<
                keyof I_1["packetFee"]["fee"]["recvFee"],
                keyof {
                  denom?: string;
                  amount?: string;
                }[]
          ...
          ackFee?: {
            ...
            ({
              ...
              [K_14 in Exclude<
                keyof I_1["packetFee"]["fee"]["ackFee"][number],
                keyof import("../../../../cosmos/base/v1beta1/coin").Coin
              >]: never;
            })[] & {
              [K_15 in Exclude<
                keyof I_1["packetFee"]["fee"]["ackFee"],
                keyof {
                  denom?: string;
                  amount?: string;
                }[]
          ...
          timeoutFee?: {
            ...
            ({
              ...
              [K_16 in Exclude<
                keyof I_1["packetFee"]["fee"]["timeoutFee"][number],
                keyof import("../../../../cosmos/base/v1beta1/coin").Coin
              >]: never;
            })[] & {
              [K_17 in Exclude<
                keyof I_1["packetFee"]["fee"]["timeoutFee"],
                keyof {
                  denom?: string;
                  amount?: string;
                }[]
        ...
        relayers?: string[] &
          string[] & {
            [K_19 in Exclude<
              keyof I_1["packetFee"]["relayers"],
              keyof string[]
            >]: never;
          };
      } & { [K_20 in Exclude<keyof I_1["packetFee"], keyof PacketFee>]: never };
    } & { [K_21 in Exclude<keyof I_1, keyof MsgPayPacketFeeAsync>]: never }
  >(
    object: I_1
  ): MsgPayPacketFeeAsync;
};
