...
export declare const Channel: {
  ...
  create<
    I extends {
      ...
      connectionHops?: string[] &
        string[] & {
          [K_1 in Exclude<keyof I["connectionHops"], keyof string[]>]: never;
        };
      version?: string;
    } & { [K_2 in Exclude<keyof I, keyof Channel>]: never }
  >(
    base?: I
  ): Channel;
  fromPartial<
    I_1 extends {
      ...
      connectionHops?: string[] &
        string[] & {
          [K_4 in Exclude<keyof I_1["connectionHops"], keyof string[]>]: never;
        };
      version?: string;
    } & { [K_5 in Exclude<keyof I_1, keyof Channel>]: never }
  >(
    object: I_1
  ): Channel;
};
export declare const IdentifiedChannel: {
  ...
  create<
    I extends {
      ...
      portId?: string;
      channelId?: string;
    } & { [K_2 in Exclude<keyof I, keyof IdentifiedChannel>]: never }
  >(
    base?: I
  ): IdentifiedChannel;
  fromPartial<
    I_1 extends {
      ...
      portId?: string;
      channelId?: string;
    } & { [K_5 in Exclude<keyof I_1, keyof IdentifiedChannel>]: never }
  >(
    object: I_1
  ): IdentifiedChannel;
};
export declare const Counterparty: {
  ...
  create<
    I extends {
      ...
      portId?: string;
      channelId?: string;
    } & { [K in Exclude<keyof I, keyof Counterparty>]: never }
  >(
    base?: I
  ): Counterparty;
  fromPartial<
    I_1 extends {
      ...
      portId?: string;
      channelId?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof Counterparty>]: never }
  >(
    object: I_1
  ): Counterparty;
};
export declare const Packet: {
  ...
  create<
    I extends {
      ...
      timeoutTimestamp?: string;
    } & { [K_1 in Exclude<keyof I, keyof Packet>]: never }
  >(
    base?: I
  ): Packet;
  fromPartial<
    I_1 extends {
      ...
      timeoutTimestamp?: string;
    } & { [K_3 in Exclude<keyof I_1, keyof Packet>]: never }
  >(
    object: I_1
  ): Packet;
};
export declare const PacketState: {
  ...
  create<
    I extends {
      ...
      sequence?: string;
      data?: Uint8Array;
    } & { [K in Exclude<keyof I, keyof PacketState>]: never }
  >(
    base?: I
  ): PacketState;
  fromPartial<
    I_1 extends {
      ...
      sequence?: string;
      data?: Uint8Array;
    } & { [K_1 in Exclude<keyof I_1, keyof PacketState>]: never }
  >(
    object: I_1
  ): PacketState;
};
export declare const PacketId: {
  ...
  create<
    I extends {
      ...
      channelId?: string;
      sequence?: string;
    } & { [K in Exclude<keyof I, keyof PacketId>]: never }
  >(
    base?: I
  ): PacketId;
  fromPartial<
    I_1 extends {
      ...
      channelId?: string;
      sequence?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof PacketId>]: never }
  >(
    object: I_1
  ): PacketId;
};
export declare const Acknowledgement: {
  ...
  create<
    I extends {
      ...
      result?: Uint8Array | undefined;
      error?: string | undefined;
    } & { [K in Exclude<keyof I, keyof Acknowledgement>]: never }
  >(
    base?: I
  ): Acknowledgement;
  fromPartial<
    I_1 extends {
      ...
      result?: Uint8Array | undefined;
      error?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof Acknowledgement>]: never }
  >(
    object: I_1
  ): Acknowledgement;
};
export declare const Timeout: {
  ...
  create<
    I extends {
      ...
      timestamp?: string;
    } & { [K_1 in Exclude<keyof I, keyof Timeout>]: never }
  >(
    base?: I
  ): Timeout;
  fromPartial<
    I_1 extends {
      ...
      timestamp?: string;
    } & { [K_3 in Exclude<keyof I_1, keyof Timeout>]: never }
  >(
    object: I_1
  ): Timeout;
};
