...
export declare const IdentifiedClientState: {
  ...
  create<
    ...
    } & { [K_1 in Exclude<keyof I, keyof IdentifiedClientState>]: never }
  >(
    base?: I
  ): IdentifiedClientState;
  fromPartial<
    ...
    } & { [K_3 in Exclude<keyof I_1, keyof IdentifiedClientState>]: never }
  >(
    object: I_1
  ): IdentifiedClientState;
};
export declare const ConsensusStateWithHeight: {
  ...
  create<
    ...
    } & { [K_2 in Exclude<keyof I, keyof ConsensusStateWithHeight>]: never }
  >(
    base?: I
  ): ConsensusStateWithHeight;
  fromPartial<
    ...
    } & { [K_5 in Exclude<keyof I_1, keyof ConsensusStateWithHeight>]: never }
  >(
    object: I_1
  ): ConsensusStateWithHeight;
};
export declare const ClientConsensusStates: {
  ...
  create<
      ...
      consensusStates?: {
        ...
        ({
          ...
          height?: {
            ...
            [K in Exclude<
              keyof I["consensusStates"][number]["height"],
              keyof Height
            >]: never;
          };
          consensusState?: {
            ...
            [K_1 in Exclude<
              keyof I["consensusStates"][number]["consensusState"],
              keyof Any
            >]: never;
          };
        } & {
          [K_2 in Exclude<
            keyof I["consensusStates"][number],
            keyof ConsensusStateWithHeight
          >]: never;
        })[] & {
          [K_3 in Exclude<
            keyof I["consensusStates"],
            keyof {
              height?: {
                revisionNumber?: string;
                revisionHeight?: string;
    ...
    } & { [K_4 in Exclude<keyof I, keyof ClientConsensusStates>]: never }
  >(
    base?: I
  ): ClientConsensusStates;
  fromPartial<
      ...
      consensusStates?: {
        ...
        ({
          ...
          height?: {
            ...
            [K_5 in Exclude<
              keyof I_1["consensusStates"][number]["height"],
              keyof Height
            >]: never;
          };
          consensusState?: {
            ...
            [K_6 in Exclude<
              keyof I_1["consensusStates"][number]["consensusState"],
              keyof Any
            >]: never;
          };
        } & {
          [K_7 in Exclude<
            keyof I_1["consensusStates"][number],
            keyof ConsensusStateWithHeight
          >]: never;
        })[] & {
          [K_8 in Exclude<
            keyof I_1["consensusStates"],
            keyof {
              height?: {
                revisionNumber?: string;
                revisionHeight?: string;
    ...
    } & { [K_9 in Exclude<keyof I_1, keyof ClientConsensusStates>]: never }
  >(
    object: I_1
  ): ClientConsensusStates;
};
export declare const ClientUpdateProposal: {
  ...
  create<
    I extends {
      ...
      subjectClientId?: string;
      substituteClientId?: string;
    } & { [K in Exclude<keyof I, keyof ClientUpdateProposal>]: never }
  >(
    base?: I
  ...
  fromPartial<
    I_1 extends {
      ...
      subjectClientId?: string;
      substituteClientId?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof ClientUpdateProposal>]: never }
  >(
    object: I_1
  ): ClientUpdateProposal;
};
export declare const UpgradeProposal: {
  ...
  create<
    I extends {
      ...
      plan?: {
        ...
        upgradedClientState?: {
          ...
          [K in Exclude<
            keyof I["plan"]["upgradedClientState"],
            keyof Any
          >]: never;
        };
    ...
    } & { [K_3 in Exclude<keyof I, keyof UpgradeProposal>]: never }
  >(
    base?: I
  ): UpgradeProposal;
  fromPartial<
    I_1 extends {
      ...
      plan?: {
        ...
        upgradedClientState?: {
          ...
          [K_4 in Exclude<
            keyof I_1["plan"]["upgradedClientState"],
            keyof Any
          >]: never;
        };
    ...
    } & { [K_7 in Exclude<keyof I_1, keyof UpgradeProposal>]: never }
  >(
    object: I_1
  ): UpgradeProposal;
};
export declare const Height: {
  ...
  create<
    I extends {
      ...
      revisionNumber?: string;
      revisionHeight?: string;
    } & { [K in Exclude<keyof I, keyof Height>]: never }
  >(
    base?: I
  ): Height;
  fromPartial<
    I_1 extends {
      ...
      revisionNumber?: string;
      revisionHeight?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof Height>]: never }
  >(
    object: I_1
  ): Height;
};
export declare const Params: {
  ...
  create<
    I extends {
      ...
      allowedClients?: string[] &
        string[] & {
          [K in Exclude<keyof I["allowedClients"], keyof string[]>]: never;
        };
    } & { [K_1 in Exclude<keyof I, "allowedClients">]: never }
  >(
    base?: I
  ): Params;
  fromPartial<
    I_1 extends {
      ...
      allowedClients?: string[] &
        string[] & {
          [K_2 in Exclude<keyof I_1["allowedClients"], keyof string[]>]: never;
        };
    } & { [K_3 in Exclude<keyof I_1, "allowedClients">]: never }
  >(
    object: I_1
  ): Params;
};
