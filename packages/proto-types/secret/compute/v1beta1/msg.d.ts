...
export declare const MsgStoreCode: {
    ...
    create<I extends {
        ...
        source?: string;
        builder?: string;
    } & { [K in Exclude<keyof I, keyof MsgStoreCode>]: never; }>(base?: I): MsgStoreCode;
    fromPartial<I_1 extends {
        ...
        source?: string;
        builder?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgStoreCode>]: never; }>(object: I_1): MsgStoreCode;
};
export declare const MsgInstantiateContract: {
    ...
    create<I extends {
        ...
        initFunds?: {
            ...
            denom?: string;
            amount?: string;
        } & { [K in Exclude<keyof I["initFunds"][number], keyof Coin>]: never; })[] & { [K_1 in Exclude<keyof I["initFunds"], keyof {
            denom?: string;
            amount?: string;
        }[]>]: never; };
        callbackSig?: Uint8Array;
    ...
    fromPartial<I_1 extends {
        ...
        initFunds?: {
            ...
            denom?: string;
            amount?: string;
        } & { [K_3 in Exclude<keyof I_1["initFunds"][number], keyof Coin>]: never; })[] & { [K_4 in Exclude<keyof I_1["initFunds"], keyof {
            denom?: string;
            amount?: string;
        }[]>]: never; };
        callbackSig?: Uint8Array;
...
export declare const MsgExecuteContract: {
    ...
    create<I extends {
        ...
        sentFunds?: {
            ...
            denom?: string;
            amount?: string;
        } & { [K in Exclude<keyof I["sentFunds"][number], keyof Coin>]: never; })[] & { [K_1 in Exclude<keyof I["sentFunds"], keyof {
            denom?: string;
            amount?: string;
        }[]>]: never; };
        callbackSig?: Uint8Array;
    ...
    fromPartial<I_1 extends {
        ...
        sentFunds?: {
            ...
            denom?: string;
            amount?: string;
        } & { [K_3 in Exclude<keyof I_1["sentFunds"][number], keyof Coin>]: never; })[] & { [K_4 in Exclude<keyof I_1["sentFunds"], keyof {
            denom?: string;
            amount?: string;
        }[]>]: never; };
        callbackSig?: Uint8Array;
