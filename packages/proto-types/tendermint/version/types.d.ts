...
export declare const App: {
  ...
  create<
    I extends {
      ...
      protocol?: string;
      software?: string;
    } & { [K in Exclude<keyof I, keyof App>]: never }
  >(
    base?: I
  ): App;
  fromPartial<
    I_1 extends {
      ...
      protocol?: string;
      software?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof App>]: never }
  >(
    object: I_1
  ): App;
};
export declare const Consensus: {
  ...
  create<
    I extends {
      ...
      block?: string;
      app?: string;
    } & { [K in Exclude<keyof I, keyof Consensus>]: never }
  >(
    base?: I
  ): Consensus;
  fromPartial<
    I_1 extends {
      ...
      block?: string;
      app?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof Consensus>]: never }
  >(
    object: I_1
  ): Consensus;
};
