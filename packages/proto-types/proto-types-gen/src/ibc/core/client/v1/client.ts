...
export const IdentifiedClientState = {
  ...
  create<I extends Exact<DeepPartial<IdentifiedClientState>, I>>(
    base?: I
  ): IdentifiedClientState {
  ...
  toJSON(message: ClientConsensusStates): unknown {
    ...
    if (message.consensusStates?.length) {
      obj.consensusStates = message.consensusStates.map((e) =>
        ConsensusStateWithHeight.toJSON(e)
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ClientConsensusStates>, I>>(
    base?: I
  ): ClientConsensusStates {
...
export const ClientUpdateProposal = {
  ...
  create<I extends Exact<DeepPartial<ClientUpdateProposal>, I>>(
    base?: I
  ): ClientUpdateProposal {
  ...
  fromJSON(object: any): Height {
    return {
      revisionNumber: isSet(object.revisionNumber)
        ? globalThis.String(object.revisionNumber)
        : "0",
      revisionHeight: isSet(object.revisionHeight)
        ? globalThis.String(object.revisionHeight)
        : "0",
    };
  },
