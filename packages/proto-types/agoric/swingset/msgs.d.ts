...
export declare const MsgDeliverInbound: {
    ...
    create<I extends {
        ...
        messages?: string[] & string[] & { [K in Exclude<keyof I["messages"], keyof string[]>]: never; };
        nums?: string[] & string[] & { [K_1 in Exclude<keyof I["nums"], keyof string[]>]: never; };
        ack?: string;
        submitter?: Uint8Array;
    } & { [K_2 in Exclude<keyof I, keyof MsgDeliverInbound>]: never; }>(base?: I): MsgDeliverInbound;
    fromPartial<I_1 extends {
        ...
        messages?: string[] & string[] & { [K_3 in Exclude<keyof I_1["messages"], keyof string[]>]: never; };
        nums?: string[] & string[] & { [K_4 in Exclude<keyof I_1["nums"], keyof string[]>]: never; };
        ack?: string;
        submitter?: Uint8Array;
    } & { [K_5 in Exclude<keyof I_1, keyof MsgDeliverInbound>]: never; }>(object: I_1): MsgDeliverInbound;
};
export declare const MsgDeliverInboundResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgDeliverInboundResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgDeliverInboundResponse;
};
export declare const MsgWalletAction: {
    ...
    create<I extends {
        ...
        owner?: Uint8Array;
        action?: string;
    } & { [K in Exclude<keyof I, keyof MsgWalletAction>]: never; }>(base?: I): MsgWalletAction;
    fromPartial<I_1 extends {
        owner?: Uint8Array;
        action?: string;
    } & {
        owner?: Uint8Array;
        action?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgWalletAction>]: never; }>(object: I_1): MsgWalletAction;
};
export declare const MsgWalletActionResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgWalletActionResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgWalletActionResponse;
};
export declare const MsgWalletSpendAction: {
    ...
    create<I extends {
        ...
        owner?: Uint8Array;
        spendAction?: string;
    } & { [K in Exclude<keyof I, keyof MsgWalletSpendAction>]: never; }>(base?: I): MsgWalletSpendAction;
    fromPartial<I_1 extends {
        owner?: Uint8Array;
        spendAction?: string;
    } & {
        owner?: Uint8Array;
        spendAction?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgWalletSpendAction>]: never; }>(object: I_1): MsgWalletSpendAction;
};
export declare const MsgWalletSpendActionResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgWalletSpendActionResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgWalletSpendActionResponse;
};
export declare const MsgProvision: {
    ...
    create<I extends {
        ...
        nickname?: string;
        address?: Uint8Array;
        powerFlags?: string[] & string[] & { [K in Exclude<keyof I["powerFlags"], keyof string[]>]: never; };
        submitter?: Uint8Array;
    } & { [K_1 in Exclude<keyof I, keyof MsgProvision>]: never; }>(base?: I): MsgProvision;
    fromPartial<I_1 extends {
        nickname?: string;
        address?: Uint8Array;
        powerFlags?: string[];
        ...
        nickname?: string;
        address?: Uint8Array;
        powerFlags?: string[] & string[] & { [K_2 in Exclude<keyof I_1["powerFlags"], keyof string[]>]: never; };
        submitter?: Uint8Array;
    } & { [K_3 in Exclude<keyof I_1, keyof MsgProvision>]: never; }>(object: I_1): MsgProvision;
};
export declare const MsgProvisionResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgProvisionResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgProvisionResponse;
};
export declare const MsgInstallBundle: {
    ...
    create<I extends {
        ...
        compressedBundle?: Uint8Array;
        uncompressedSize?: string;
    } & { [K in Exclude<keyof I, keyof MsgInstallBundle>]: never; }>(base?: I): MsgInstallBundle;
    fromPartial<I_1 extends {
        bundle?: string;
        submitter?: Uint8Array;
        compressedBundle?: Uint8Array;
        ...
        compressedBundle?: Uint8Array;
        uncompressedSize?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgInstallBundle>]: never; }>(object: I_1): MsgInstallBundle;
};
export declare const MsgInstallBundleResponse: {
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgInstallBundleResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgInstallBundleResponse;
};
/** Transactions. */
