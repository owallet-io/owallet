...
export declare const AccessTypeParam: {
  ...
  fromPartial<
    I_1 extends {
      ...
      value?: AccessType;
    } & { [K_1 in Exclude<keyof I_1, "value">]: never }
  >(
    object: I_1
  ): AccessTypeParam;
};
export declare const AccessConfig: {
  ...
  create<
    I extends {
      ...
      permission?: AccessType;
      address?: string;
    } & { [K in Exclude<keyof I, keyof AccessConfig>]: never }
  >(
    base?: I
  ): AccessConfig;
  fromPartial<
    I_1 extends {
      ...
      permission?: AccessType;
      address?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof AccessConfig>]: never }
  >(
    object: I_1
  ): AccessConfig;
};
  ...
  create<
    I extends {
      ...
      codeUploadAccess?: {
        ...
        [K in Exclude<keyof I["codeUploadAccess"], keyof AccessConfig>]: never;
      };
      instantiateDefaultPermission?: AccessType;
      maxWasmCodeSize?: string;
  ...
  create<
    I extends {
      ...
      instantiateConfig?: {
        ...
        [K in Exclude<keyof I["instantiateConfig"], keyof AccessConfig>]: never;
      };
    } & { [K_1 in Exclude<keyof I, keyof CodeInfo>]: never }
  >(
    base?: I
  ): CodeInfo;
  fromPartial<
    I_1 extends {
      ...
      instantiateConfig?: {
        ...
        [K_2 in Exclude<
          keyof I_1["instantiateConfig"],
          keyof AccessConfig
        >]: never;
      };
    } & { [K_3 in Exclude<keyof I_1, keyof CodeInfo>]: never }
  >(
    object: I_1
  ): CodeInfo;
};
export declare const ContractInfo: {
  ...
  create<
    ...
    } & { [K_2 in Exclude<keyof I, keyof ContractInfo>]: never }
  >(
    base?: I
  ): ContractInfo;
  fromPartial<
    ...
    } & { [K_5 in Exclude<keyof I_1, keyof ContractInfo>]: never }
  >(
    object: I_1
  ): ContractInfo;
};
export declare const ContractCodeHistoryEntry: {
  ...
  create<
    I extends {
      ...
      msg?: Uint8Array;
    } & { [K_1 in Exclude<keyof I, keyof ContractCodeHistoryEntry>]: never }
  >(
    base?: I
  ): ContractCodeHistoryEntry;
  fromPartial<
    I_1 extends {
      ...
      msg?: Uint8Array;
    } & { [K_3 in Exclude<keyof I_1, keyof ContractCodeHistoryEntry>]: never }
  >(
    object: I_1
  ): ContractCodeHistoryEntry;
};
export declare const AbsoluteTxPosition: {
  ...
  create<
    I extends {
      ...
      blockHeight?: string;
      txIndex?: string;
    } & { [K in Exclude<keyof I, keyof AbsoluteTxPosition>]: never }
  >(
    base?: I
  ): AbsoluteTxPosition;
  fromPartial<
    I_1 extends {
      ...
      blockHeight?: string;
      txIndex?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof AbsoluteTxPosition>]: never }
  >(
    object: I_1
  ): AbsoluteTxPosition;
};
export declare const Model: {
  ...
  create<
    I extends {
      ...
      key?: Uint8Array;
      value?: Uint8Array;
    } & { [K in Exclude<keyof I, keyof Model>]: never }
  >(
    base?: I
  ): Model;
  fromPartial<
    I_1 extends {
      ...
      key?: Uint8Array;
      value?: Uint8Array;
    } & { [K_1 in Exclude<keyof I_1, keyof Model>]: never }
  >(
    object: I_1
  ): Model;
};
