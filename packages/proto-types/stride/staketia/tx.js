...
const staketia_1 = require("./staketia");
...
exports.MsgOverwriteDelegationRecord = {
    ...
    fromJSON(object) {
        return {
            creator: isSet(object.creator) ? globalThis.String(object.creator) : "",
            delegationRecord: isSet(object.delegationRecord) ? staketia_1.DelegationRecord.fromJSON(object.delegationRecord) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.delegationRecord !== undefined) {
            obj.delegationRecord = staketia_1.DelegationRecord.toJSON(message.delegationRecord);
        }
        return obj;
    },
    create(base) {
...
exports.MsgOverwriteUnbondingRecord = {
    ...
    fromJSON(object) {
        return {
            creator: isSet(object.creator) ? globalThis.String(object.creator) : "",
            unbondingRecord: isSet(object.unbondingRecord) ? staketia_1.UnbondingRecord.fromJSON(object.unbondingRecord) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.unbondingRecord !== undefined) {
            obj.unbondingRecord = staketia_1.UnbondingRecord.toJSON(message.unbondingRecord);
        }
        return obj;
    },
    create(base) {
...
exports.MsgOverwriteRedemptionRecord = {
    ...
    fromJSON(object) {
        return {
            creator: isSet(object.creator) ? globalThis.String(object.creator) : "",
            redemptionRecord: isSet(object.redemptionRecord) ? staketia_1.RedemptionRecord.fromJSON(object.redemptionRecord) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.redemptionRecord !== undefined) {
            obj.redemptionRecord = staketia_1.RedemptionRecord.toJSON(message.redemptionRecord);
        }
        return obj;
    },
    create(base) {
