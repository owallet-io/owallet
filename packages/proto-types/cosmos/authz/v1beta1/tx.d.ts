...
export declare const MsgGrant: {
  ...
  create<
    ...
    } & { [K_2 in Exclude<keyof I, keyof MsgGrant>]: never }
  >(
    base?: I
  ): MsgGrant;
  fromPartial<
    I_1 extends {
      ...
      grant?: {
        ...
        authorization?: {
          ...
          [K_3 in Exclude<
            keyof I_1["grant"]["authorization"],
            keyof Any
          >]: never;
        };
        expiration?: Date;
      } & { [K_4 in Exclude<keyof I_1["grant"], keyof Grant>]: never };
    } & { [K_5 in Exclude<keyof I_1, keyof MsgGrant>]: never }
  >(
    object: I_1
  ): MsgGrant;
};
export declare const MsgExecResponse: {
  ...
  create<
    I extends {
      ...
      results?: Uint8Array[] &
        Uint8Array[] & {
          [K in Exclude<keyof I["results"], keyof Uint8Array[]>]: never;
        };
    } & { [K_1 in Exclude<keyof I, "results">]: never }
  >(
    base?: I
  ): MsgExecResponse;
  fromPartial<
    I_1 extends {
      ...
      results?: Uint8Array[] &
        Uint8Array[] & {
          [K_2 in Exclude<keyof I_1["results"], keyof Uint8Array[]>]: never;
        };
    } & { [K_3 in Exclude<keyof I_1, "results">]: never }
  >(
    object: I_1
  ): MsgExecResponse;
};
export declare const MsgExec: {
  ...
  create<
    I extends {
      ...
      msgs?: {
        ...
        ({
          ...
          typeUrl?: string;
          value?: Uint8Array;
        } & { [K in Exclude<keyof I["msgs"][number], keyof Any>]: never })[] & {
          [K_1 in Exclude<
            keyof I["msgs"],
            keyof {
              typeUrl?: string;
    ...
    } & { [K_2 in Exclude<keyof I, keyof MsgExec>]: never }
  >(
    base?: I
  ): MsgExec;
  fromPartial<
    I_1 extends {
      ...
      msgs?: {
        ...
        ({
          ...
          [K_3 in Exclude<keyof I_1["msgs"][number], keyof Any>]: never;
        })[] & {
          [K_4 in Exclude<
            keyof I_1["msgs"],
            keyof {
    ...
    } & { [K_5 in Exclude<keyof I_1, keyof MsgExec>]: never }
  >(
    object: I_1
  ): MsgExec;
};
...
export declare const MsgRevoke: {
  ...
  create<
    I extends {
      ...
      grantee?: string;
      msgTypeUrl?: string;
    } & { [K in Exclude<keyof I, keyof MsgRevoke>]: never }
  >(
    base?: I
  ): MsgRevoke;
  fromPartial<
    I_1 extends {
      ...
      grantee?: string;
      msgTypeUrl?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgRevoke>]: never }
  >(
    object: I_1
  ): MsgRevoke;
};
