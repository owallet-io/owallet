    ...
    I extends {
      ...
      denyList?: {
        ...
        address?: string[] &
          string[] & {
            [K_3 in Exclude<
              keyof I["denyList"]["address"],
              keyof string[]
            >]: never;
          };
      } & { [K_4 in Exclude<keyof I["denyList"], "address">]: never };
      authorizationType?: AuthorizationType;
    } & { [K_5 in Exclude<keyof I, keyof StakeAuthorization>]: never }
  >(
    base?: I
  ): StakeAuthorization;
  fromPartial<
    I_1 extends {
      ...
      denyList?: {
        ...
        address?: string[] &
          string[] & {
            [K_9 in Exclude<
              keyof I_1["denyList"]["address"],
              keyof string[]
            >]: never;
          };
      } & { [K_10 in Exclude<keyof I_1["denyList"], "address">]: never };
      authorizationType?: AuthorizationType;
    } & { [K_11 in Exclude<keyof I_1, keyof StakeAuthorization>]: never }
  >(
    object: I_1
  ): StakeAuthorization;
};
export declare const StakeAuthorization_Validators: {
  ...
  create<
    I extends {
      ...
      address?: string[] &
        string[] & {
          [K in Exclude<keyof I["address"], keyof string[]>]: never;
        };
    } & { [K_1 in Exclude<keyof I, "address">]: never }
  >(
    base?: I
  ): StakeAuthorization_Validators;
  fromPartial<
    I_1 extends {
      ...
      address?: string[] &
        string[] & {
          [K_2 in Exclude<keyof I_1["address"], keyof string[]>]: never;
        };
    } & { [K_3 in Exclude<keyof I_1, "address">]: never }
  >(
    object: I_1
  ): StakeAuthorization_Validators;
};
