...
export declare const TextProposal: {
  ...
  create<
    I extends {
      ...
      title?: string;
      description?: string;
    } & { [K in Exclude<keyof I, keyof TextProposal>]: never }
  >(
    base?: I
  ): TextProposal;
  fromPartial<
    I_1 extends {
      ...
      title?: string;
      description?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof TextProposal>]: never }
  >(
    object: I_1
  ): TextProposal;
};
    ...
    I extends {
      ...
      totalDeposit?: {
        ...
        ({
          ...
          [K_2 in Exclude<keyof I["totalDeposit"][number], keyof Coin>]: never;
        })[] & {
          [K_3 in Exclude<
            keyof I["totalDeposit"],
            keyof {
              denom?: string;
              amount?: string;
            }[]
      ...
      votingStartTime?: Date | undefined;
      votingEndTime?: Date | undefined;
    } & { [K_4 in Exclude<keyof I, keyof Proposal>]: never }
  >(
    base?: I
  ): Proposal;
  fromPartial<
    I_1 extends {
      ...
      totalDeposit?: {
        ...
        ({
          ...
          [K_7 in Exclude<
            keyof I_1["totalDeposit"][number],
            keyof Coin
          >]: never;
        })[] & {
          [K_8 in Exclude<
            keyof I_1["totalDeposit"],
            keyof {
              denom?: string;
              amount?: string;
            }[]
      ...
      votingStartTime?: Date | undefined;
      votingEndTime?: Date | undefined;
    } & { [K_9 in Exclude<keyof I_1, keyof Proposal>]: never }
  >(
    object: I_1
  ): Proposal;
};
    ...
    I extends {
      ...
      minDeposit?: {
        ...
        ({
          ...
          [K in Exclude<keyof I["minDeposit"][number], keyof Coin>]: never;
        })[] & {
          [K_1 in Exclude<
            keyof I["minDeposit"],
            keyof {
    ...
    I_1 extends {
      ...
      minDeposit?: {
        ...
        ({
          ...
          [K_4 in Exclude<keyof I_1["minDeposit"][number], keyof Coin>]: never;
        })[] & {
          [K_5 in Exclude<
            keyof I_1["minDeposit"],
            keyof {
              denom?: string;
              amount?: string;
            }[]
...
export declare const VotingParams: {
  ...
  create<
    ...
    } & { [K_1 in Exclude<keyof I, "votingPeriod">]: never }
  >(
    base?: I
  ): VotingParams;
  fromPartial<
    ...
    } & { [K_3 in Exclude<keyof I_1, "votingPeriod">]: never }
  >(
    object: I_1
  ): VotingParams;
};
