...
export declare const Plan: {
  ...
  fromPartial<
    ...
    } & { [K_3 in Exclude<keyof I_1, keyof Plan>]: never }
  >(
    object: I_1
  ): Plan;
};
export declare const SoftwareUpgradeProposal: {
  ...
  fromPartial<
    ...
    } & { [K_5 in Exclude<keyof I_1, keyof SoftwareUpgradeProposal>]: never }
  >(
    object: I_1
  ): SoftwareUpgradeProposal;
};
export declare const CancelSoftwareUpgradeProposal: {
  ...
  fromPartial<
    I_1 extends {
      ...
      [K_1 in Exclude<keyof I_1, keyof CancelSoftwareUpgradeProposal>]: never;
    }
  >(
    object: I_1
  ): CancelSoftwareUpgradeProposal;
...
export declare const ModuleVersion: {
  ...
  fromPartial<
    I_1 extends {
      ...
      name?: string;
      version?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof ModuleVersion>]: never }
  >(
    object: I_1
  ): ModuleVersion;
};
