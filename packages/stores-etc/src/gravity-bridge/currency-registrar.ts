...
import { OWalletETCQueries } from "../queries";
...
export class GravityBridgeCurrencyRegistrar {
  ...
  constructor(
    ...
    protected readonly queriesStore: IQueriesStore<OWalletETCQueries>
  ) {
  ...
  protected currencyRegistrar(
    ...
    const erc20Metadata =
      queries.owalletETC.queryERC20Metadata.get(contractAddress);
