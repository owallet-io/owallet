...
export const ScAtomIcon: FunctionComponent<{
  color?: string;
  size?: number;
  onPress?: () => void;
}> = ({ color = '#AEAEB2', size = 20, onPress }) => {
  return (
    <Svg width="44" height="44" viewBox="0 0 71 71">
      <G
        id="Group_14406"
        data-name="Group 14406"
        transform="translate(2799 3405)"
      >
        <Circle
          cx="35.5"
          cy="35.5"
        ...
        <G
          id="Group_14404"
          data-name="Group 14404"
          transform="translate(-2793 -3399)"
        >
          <Path
        ...
        <G transform="translate(-2783.046 -3389.122)">
          ...
          <Ellipse
            ...
            rx="1.687"
            ry="1.687"
            transform="translate(28.248 9.29)"
            fill="#fff"
          />
          <Ellipse
            cx="1.607"
            ...
            rx="1.607"
            ry="1.607"
            transform="translate(3.595 12.865)"
            fill="#fff"
          />
          <Ellipse
            cx="1.687"
            ...
            rx="1.687"
            ry="1.687"
            transform="translate(15.232 33.105)"
            fill="#fff"
          />
          <Ellipse
            cx="2.088"
            ...
            rx="2.088"
            ry="2.088"
            transform="translate(17.016 17.769)"
            fill="#fff"
          />
        </G>
      </G>
