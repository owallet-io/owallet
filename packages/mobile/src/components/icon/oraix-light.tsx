...
export const OraixLightIcon: FunctionComponent<{
  color?: string;
  size?: number;
  onPress?: () => void;
  ...
  return (
    <Svg width="45" height="44" viewBox="0 0 45 44" fill="none">
      ...
      <Defs>
        ...
        >
          <Stop Stop-color="white" Stop-opacity="0" />
          <Stop offset="0.9809" Stop-color="white" />
        </LinearGradient>
      </Defs>
    </Svg>
  );
