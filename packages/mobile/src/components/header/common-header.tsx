...
export const CommonPageHeader: FunctionComponent<{ title: string }> = observer(({ title }) => {
  ...
  return (
    <View>
      <PageHeader
        ...
        middle={
          <TouchableOpacity onPress={_onPressNetworkModal} style={{ alignItems: "center" }}>
            ...
            >
              <OWText style={{ paddingRight: 6 }} color={colors["neutral-text-title"]} size={13}>
        ...
        right={
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <OWIcon size={22} name="tdesignscan" color={colors["neutral-text-title"]} />
            </TouchableOpacity>
            <TouchableOpacity
              onPress={onAddWallet}
              style={{
            ...
            >
              <OWIcon size={22} name="tdesignwallet" color={colors["neutral-text-title"]} />
            </TouchableOpacity>
          </View>
        }
      />
