...
import { AddressBookConfig, AddressBookData, IMemoConfig, IRecipientConfig, RegisterConfig } from '@owallet/hooks';

import { createSmartNavigatorProvider, SmartNavigator } from './hooks';

const { SmartNavigatorProvider, useSmartNavigation } = createSmartNavigatorProvider(
  new SmartNavigator({
    'Register.Intro': {
