...
import { GovernanceDetailsScreen, GovernanceScreen } from '@src/screens/governance';
import { SelectNetworkScreen } from '@src/screens/network';
import { ValidatorDetailsScreen, ValidatorListScreen } from '@src/screens/stake';
import { TxFailedResultScreen, TxPendingResultScreen, TxSuccessResultScreen } from '@src/screens/tx-result';
...
export const OtherNavigation: FC = () => {
  ...
  return (
    <Stack.Navigator screenOptions={handleScreenOptions}>
      ...
      <Stack.Screen name={SCREENS.TransactionDetail} component={TransactionDetailScreen} />
      <Stack.Screen
        options={{
          headerShown: false
        }}
      ...
      <Stack.Screen name={SCREENS.GovernanceDetails} component={GovernanceDetailsScreen} />
      <Stack.Screen name={SCREENS.NetworkSelect} component={SelectNetworkScreen} />
