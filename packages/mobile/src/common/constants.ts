...
export const showNetworkHeader = "showNetworkHeader";
...
export const SCREENS_TITLE = {
  ...
  [SCREENS.RegisterIntro]: notShowHeader,
  [SCREENS.RegisterNewUser]: notShowHeader,
  [SCREENS.RegisterNotNewUser]: notShowHeader,
  [SCREENS.RegisterNewMnemonic]: notShowHeader,
  [SCREENS.RegisterVerifyMnemonic]: notShowHeader,
  [SCREENS.RegisterRecoverMnemonic]: notShowHeader,
  [SCREENS.RegisterNewLedger]: notShowHeader,
  [SCREENS.Send]: '',
  [SCREENS.TransferNFT]: '',
