...
export function renderDirectMessage(msg: any, currencies: AppCurrency[]) {
  if (!(msg instanceof UnknownMessage) && 'unpacked' in msg) {
    if (msg.typeUrl === '/cosmos.bank.v1beta1.MsgSend') {
      ...
      return renderMsgSend(currencies, sendMsg.amount as CoinPrimitive[], sendMsg.toAddress);
    }

    if (msg.typeUrl === '/cosmos.staking.v1beta1.MsgDelegate') {
      const delegateMsg = msg.unpacked as MsgDelegate;
      return renderMsgDelegate(currencies, delegateMsg.amount as CoinPrimitive, delegateMsg.validatorAddress);
    }
    ...
    if (msg.typeUrl === '/cosmos.staking.v1beta1.MsgUndelegate') {
      ...
      return renderMsgUndelegate(currencies, msgUndelegate.amount as CoinPrimitive, msgUndelegate.validatorAddress);
    }
    ...
    if (msg.typeUrl === '/cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward') {
      ...
      return renderMsgWithdrawDelegatorReward(msgWithdrawDelegatorReward.validatorAddress);
    }
