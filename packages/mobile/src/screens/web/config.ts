...
export const InjectedProviderUrl =
  "https://raw.githubusercontent.com/oraichain/owallet-provider/test/build-bundle/injected-provider.bundle-test.js?token=GHSAT0AAAAAACM3LPFVY5YBGWVXNKUGE2TOZT3Z3VQ";
