...
import { getTokenInfos, handleSaveHistory, HISTORY_STATUS, showToast, _keyExtract } from "@src/utils/helper";
    ...
    try {
      ...
      if (result) {
        ...
        try {
          ...
          const res = await handleSaveHistory(accountOrai.bech32Address, historyInfos);
