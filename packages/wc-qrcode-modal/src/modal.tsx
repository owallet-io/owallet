  ...
  const navigateToAppURL = useMemo(() => {
    if (checkMobile) {
      if (checkAndroid) {
        ...
        saveMobileLinkInfo({
          name: "OWallet",
          href: "intent://wcV2#Intent;package=com.io.owallet;scheme=owallet;end;",
        });

        return `intent://wcV2?${uri}#Intent;package=com.io.owallet;scheme=owallet;end;`;
      } else {
        // Save the mobile link.
        saveMobileLinkInfo({
          name: "OWallet",
