...
import { MsgSwap } from "@owallet/proto-types/noble/swap/v1/tx";
import { MsgClaimYield } from "@owallet/proto-types/noble/dollar/v1/tx";
        ...
        aminoMsgs: [
          {
            ...
            value: {
              ...
              routes: msg.value.routes.map((route) => {
                if (route.pool_id === "0") {
                  // When pool id is 0, the field should be completely removed due to omit empty.
                  return {
