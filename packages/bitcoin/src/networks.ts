...
const maxCoins: { [key: string]: number } = {
...
const availableCoins: string[] = Object.keys(networks);

const supportsRbf: { [key: string]: boolean } = {
  bitcoin: true,
  bitcoinTestnet: true,
  litecoin: false,
...
const zeroValueItems: { [key: string]: number | null } = {
  bitcoin: 0,
  bitcoinTestnet: 0,
  litecoin: 0,
  litecoinTestnet: 0,
...
const arrayTypeItems: { [key: string]: any[] | null } = {
  bitcoin: [],
  bitcoinTestnet: [],
  litecoin: [],
  litecoinTestnet: [],
...
const objectTypeItems: { [key: string]: object | null } = {
  bitcoin: {},
  bitcoinTestnet: {},
  litecoin: {},
  litecoinTestnet: {},
